        ...
        <div class="container text-center">
          ...
          <?php $arg = array(
            ...
            <figure class="col-6 col-md-3">
              <img src="<?php echo get_theme_file_uri(); ?>/assets/images/01.jpg" alt="" class="img-thumbnail">
                <h4>Cumpleaños</h4>
            </figure>
          </div>
          <?php } wp_reset_postdata(); ?>
          <div class="mb-5 mt-5">
            <button class="btn-rosa"><a href="page-galeria.html" class="boton_a">Ver Todos los trabajos</a></button>
          </div>
        </div>
      </section>
