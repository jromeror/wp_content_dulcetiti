...
function dl_enqueue_style() {
	...
	wp_register_style( 'my_style', get_theme_file_uri( '/assets/css/my_style.css'), $deps, $theme_data->get( 'Version' ), 'screen' ); /* ESTILO */
	wp_register_style( 'google-fonts', 'https://fonts.googleapis.com/css2?family=Cookie&family=PT+Sans:ital,wght@0,700;1,400&display=swap' ); /* TIPOGRAFIA */
